...
my_species <- c('hystera_busco', 'hystera_busco', 'hystera_busco', 'hystera_busco', 'hystera_busco_meta', 'hystera_busco_meta', 'hystera_busco_meta', 'hystera_busco_meta', 'pentagona_busco', 'pentagona_busco', 'pentagona_busco', 'pentagona_busco', 'pentagona_busco_meta', 'pentagona_busco_meta', 'pentagona_busco_meta', 'pentagona_busco_meta')
...
my_percentage <- c(91.4, 1.7, 2.3, 4.6, 89.4, 1.9, 2.4, 6.3, 91.1, 2.3, 2.0, 4.6, 88.5, 3.3, 2.1, 6.1)
my_values <- c(277, 5, 7, 14, 874, 19, 23, 62, 276, 7, 6, 14, 866, 32, 21, 59)
